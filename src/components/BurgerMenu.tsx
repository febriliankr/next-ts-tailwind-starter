          ...
          <Menu.Button className="inline-flex justify-center w-full px-4 py-2 text-sm font-medium rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            <HiOutlineMenu
              className={`w-8 h-8 text-violet-200 ${
                dark ? "text-white" : "text-blue-brand"
              } hover:text-blue-da`}
              aria-hidden="true"
            />
          </Menu.Button>
                      ...
                      <div>
                        <Link href={item.href}>
                          <button
                            className={`${
                              active
                                ? "text-blue-da bg-gray-50 duration-200"
                                : "text-gray-500"
                            } group flex rounded-md items-center w-full px-2 py-2 mb-1 text-xl
                        ${title === item.label ? "font-semibold" : ""}
                        `}
                          >
                            {item.label}
                          </button>
